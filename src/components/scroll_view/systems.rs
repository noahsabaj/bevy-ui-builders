...
pub fn auto_scroll_to_focused_input(
    ...
    input_query: Query<(&GlobalTransform, &ComputedNode), With<crate::components::text_input::NativeTextInput>>,
    focus_query: Query<&crate::components::text_input::TextBuffer>,
) {
